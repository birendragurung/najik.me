var ArkAdmin = new function ($) {
    ...
    function initCharts(charts) {
        ...
        var chartLines    = {
            series: {
                lines: {
                    ...
                    lineWidth: 1,
                    fill: !0,
                    fillColor: {colors: [{opacity: .1}, {opacity: .13}]}
                }, points: {show: !0, lineWidth: 2, radius: 3}, shadowSize: 0, stack: !0
            },
            grid: {hoverable: !0, clickable: !0, tickColor: "#f9f9f9", borderWidth: 0},
            legend: {show: !0, labelBoxBorderColor: "#fff"},
            colors: ["#a7b5c5", "#30a0eb"],
            xaxis: {
                ticks: [[1, "Jan"], [2, "Feb"], [3, "Mar"], [4, "Apr"], [5, "May"], [6, "Jun"], [7, "Jul"], [8, "Aug"], [9, "Sep"], [10, "Oct"], [11, "Nov"], [12, "Dec"]],
                font: {size: 12, family: "Open Sans, Arial", color: "#697695"}
            },
            yaxis: {ticks: 3, tickDecimals: 0, font: {size: 12, color: "#9da3a9"}}
        }, zoomOpts       = {
            series: {lines: {show: !0}, shadowSize: 0},
            colors: ["#30a0eb"],
            xaxis: {zoomRange: [.1, 10], panRange: [-10, 10]},
            yaxis: {zoomRange: [.1, 10], panRange: [-10, 10]},
            zoom: {interactive: !0},
            pan: {interactive: !0},
            grid: {tickColor: "#f9f9f9", borderColor: "#fff"}
        }, chartBars      = {
            series: {
                bars: {
                    show: !0,
            ...
            legend: {show: !0, labelBoxBorderColor: "#fff"},
            colors: ["#30a0eb"],
            bars: {horizontal: !1, barWidth: .7},
            grid: {hoverable: !0, clickable: !0, tickColor: "#f9f9f9", borderWidth: 0},
            xaxis: {
                ticks: [[1, "Jan"], [2, "Feb"], [3, "Mar"], [4, "Apr"], [5, "May"], [6, "Jun"], [7, "Jul"], [8, "Aug"], [9, "Sep"], [10, "Oct"], [11, "Nov"], [12, "Dec"]],
                font: {size: 12, family: "Open Sans, Arial", color: "#697695"}
            },
            yaxis: {ticks: 5, tickDecimals: 0, font: {size: 12, color: "#9da3a9"}}
        }, horizontalBars = {
            series: {
                bars: {
                    show: !0,
            ...
            colors: ["#30a0eb"],
            bars: {align: "center", barWidth: .7, horizontal: !0},
            xaxis: {
            ...
            legend: {noColumns: 0, labelBoxBorderColor: "#fff", position: "ne"},
            grid: {hoverable: !0, tickColor: "#f9f9f9", borderColor: "#fff"}
        }, realTimeBars   = {
            series: {shadowSize: 0},
            colors: ["#30a0eb"],
            yaxis: {min: 0, max: 100},
            ...
            series: {
                pie: {
                    show: !0,
                    radius: 1,
                    label: {show: !0, radius: .75, formatter: labelFormatter, background: {opacity: .5}}
                }
            }, legend: {show: !1}
        }, donutOpts      = {
            series: {
        ...
        $.each(charts, function (id, value) {
            ...
            if ($(id).length) {
                ...
                var plot = $.plot($(id), value.data, opts), previousPoint = null, previousLabel = null;
                switch (value.type) {
                    case"bars":
                        $(id).bind("plothover", function (event, pos, item) {
                            if (item) {
                                if (previousPoint != item.dataIndex) {
                                    ...
                                    var y = (item.datapoint[0].toFixed(0), item.datapoint[1].toFixed(0)), month = item.series.xaxis.ticks[item.dataIndex].label, color = item.series.color;
                    ...
                    case"zoom":
                        ...
                        }), addArrow("left", 33, 35, {left: -100}), addArrow("right", 3, 35, {left: 100}), addArrow("up", 18, 20, {top: -100}), addArrow("down", 18, 50, {top: 100});
                        break;
                    case"horizontal":
                        $(id).bind("plothover", function (event, pos, item) {
                            if (item) {
                                if (previousLabel != item.series.label || previousPoint != item.dataIndex) {
                                    ...
                                    var x = item.datapoint[0], y = item.datapoint[1], color = item.series.color;
        ...
        $.extend(!0, $.fn.dataTable.defaults, {
            ...
            var btnDisplay, btnClass, api = new $.fn.dataTable.Api(settings), classes = settings.oClasses, lang = settings.oLanguage.oPaginate, attach = function (container, buttons) {
                ...
                for (i = 0, ien = buttons.length; ien > i; i++)if (button = buttons[i], $.isArray(button))attach(container, button); else {
                    ...
                    }).append($("<a>", {href: "#"}).html(btnDisplay)).appendTo(container), settings.oApi._fnBindAction(node, {action: button}, clickHandler))
                }
            };
            ...
            bootstrap: {
                fnInit: function (oSettings, nPaging, fnDraw) {
                    ...
                    var els = $("a", nPaging);
                    $(els[0]).bind("click.DT", {action: "previous"}, fnClickHandler), $(els[1]).bind("click.DT", {action: "next"}, fnClickHandler)
    ...
    function initMaps() {
        $(".map-canvas").length && $(".map-canvas").each(function () {
            var $mapZoom = $(this).attr("map-zoom") ? parseInt($(this).attr("map-zoom")) : 11, mapOptions = {
    ...
    function initCKEditor() {
        $(".ckeditor").length && $(".ckeditor").each(function (index) {
            var $config = "true" == $(this).attr("basic-ckeditor") ? "basic" : "all", $id = "editor" + index;
            $(this).attr("id") ? $id = $(this).attr("id") : $(this).attr("id", $id), "true" == $(this).attr("contenteditable") ? CKEDITOR.inline($id, {customConfig: "../../js/ckeditor/" + $config + "-config.js"}) : CKEDITOR.replace($id, {customConfig: "../../js/ckeditor/" + $config + "-config.js"})
        })
    }
    ...
    this.initExamples = function () {
        if ($("#nestable").length) {
            ...
            $("#nestable").nestable({group: 1}).on("change", updateOutput), $("#nestable2").nestable({group: 1}).on("change", updateOutput), updateOutput($("#nestable").data("output", $("#nestable-output"))), updateOutput($("#nestable2").data("output", $("#nestable2-output"))), $("#nestable-menu").on("click", function (e) {
...
jQuery(function () {
    ...
    var zoomData = [d1], charts = {
        ...
        "#chartZoom": {type: "zoom", data: zoomData},
        "#dashboardRevenues": {
            type: "bars",
            data: [{
                label: "Sales",
        ...
        "#horizontal": {
            ...
            data: [{
                ...
                data: [[1582.3, 0], [28.95, 1], [1603, 2], [774, 3], [1245, 4], [85, 5], [1025, 6]]
            }]
        },
        "#realTime": {type: "realTime", data: [], updateInterval: 30},
        "#chartPie": {type: "pie", data: pieData},
        "#chartDonut": {type: "donut", data: pieData}
    };
