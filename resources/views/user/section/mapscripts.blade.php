...
<script>
    ...
    var map, infoWindow;
    function initMap() {
        var oldLatLng = { {!! old('business_latitude')?'lat:' . old('business_latitude') . ',' : ""!!}  {!! old('business_longitude') ?'lng :' . old('business_longitude') :""!!} };
        map        = new google.maps.Map(document.getElementById('map'), {
            ...
            center: (Object.keys(oldLatLng).length === 0 && oldLatLng.constructor === Object)?{lat: 27.690497, lng: 83.465111}:oldLatLng,
            zoom: 16
        });
        ...
        $("#map").locationpicker({
            location: {latitude: 27.690497, longitude: 83.465111},
            radius: 0,
            inputBinding: {
